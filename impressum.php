	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<p>
					Christoph Sauer<br /> Rodheimerstraße 28<br /> 35444 Biebertal
				</p>
				<h2>Kontakt:</h2>
				Telefon: +49 171-8686473<br /> E-Mail: info@sauer-chris.de
				<h2>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</h2>
				<p>
					Christoph Sauer<br /> Rodheimerstraße 28<br /> 35444 Biebertal<br />
					Tel.: +49 171-8686473<br /> E-Mail: info@sauer-chris.de
				</p>
				<h2>Quellenangaben für die verwendeten Bilder und Grafiken:</h2>
				<p>
					<a href="http://www.pixabay.de">http://www.pixabay.de</a>
				</p>
				<p>
					Quelle: <em><a rel="nofollow" href="http://www.e-recht24.de">http://www.e-recht24.de</a></em>
				</p>
				...
				<div class="ig_attention">
					<ol>
						<li>Stellen Sie die Datenschutzerklärung auf einer separaten Seite
							ein. Verlinken Sie diese mit "Datenschutz" gut sichtbar von allen
							Seiten.</li>
						<li><strong>Für Online Shops ist dieses Muster nicht geeignet</strong>.
							<a href="http://seiten.e-recht24.de/widerruf/">Hier finden Sie
								eine Datenschutzerklärung für Onlineshops, eBay, Amazon & Co.</a></li>
					</ol>
				</div>
				<br />
				...
				<p></p>
				<p>
					<strong>Datenschutzerklärung für die Nutzung von Facebook-Plugins
						(Like-Button)</strong>
				</p>
				<p>
					...
					Seite. Eine Übersicht über die Facebook-Plugins finden Sie hier: <a	href="http://developers.facebook.com/docs/plugins/" title="Facebook Plugins Page">Facebook Plugins Page</a>.
				</p>
				<p>
					...
					Seiten Ihrem Benutzerkonto zuordnen. Wir weisen darauf hin, dass
					...
					von Facebook unter <a href="http://de-de.facebook.com/policy.php" title="Facebook Policy Page">Facebook Policy</a>.
				</p>
				<p>
					<a href="http://de-de.facebook.com/policy.php">Facebook Polixy</a>Wenn Sie nicht
					wünschen, dass Facebook den Besuch unserer Seiten Ihrem Facebook-
				...
				<p>Unsere Seiten nutzen Funktionen von Google +1. Anbieter ist die
					Google Inc. 1600 Amphitheatre Parkway Mountain View, CA 94043, USA.</p>
				<p>Erfassung und Weitergabe von Informationen: Mithilfe der Google
					...
					werden. Google zeichnet Informationen über Ihre +1-Aktivitäten auf,
					...
					allen Google-Diensten verwendet. In manchen Fällen kann dieser Name
					auch einen anderen Namen ersetzen, den Sie beim Teilen von Inhalten
					über Ihr Google-Konto verwendet haben. Die Identität Ihres Google-
				...
				<p>
					...
					etracker GmbH, Erste Brunnenstraße 1 20459 Hamburg Germany. <br />Aus
					den Daten können unter einem Pseudonym Nutzungsprofile erstellt
					werden. Dazu können Cookies eingesetzt werden. Bei Cookies handelt
					es sich um kleine Textdateien, die lokal im Zwischenspeicher Ihres
					Internet-Browsers gespeichert werden. Die Cookies ermöglichen es,
					...
					Betroffenen nicht genutzt, Besucher unserer Website persönlich zu
					identifizieren und werden nicht mit personenbezogenen Daten über
					den Träger des Pseudonyms zusammengeführt.
				</p>
				<p>
					Der Datenerhebung und -speicherung können Sie jederzeit mit Wirkung
					für die Zukunft widersprechen. Um einer Datenerhebung und
					-speicherung Ihrer Besucherdaten für die Zukunft zu widersprechen,
					können Sie unter nachfolgendem Link ein Opt-Out-Cookie von etracker
					beziehen, dieser bewirkt, dass zukünftig keine Besucherdaten Ihres
				...
				<p>
					...
					etracker gesetzt. Bitte l&oouml;schen diesen Cookie nicht, solange
					Sie Ihren Widerspruch aufrecht erhalten möchten. Weitere
					Informationen finden Sie in den Datenschutzbestimmungen von
					etracker: <a href="http://www.etracker.com/de/datenschutz.html">http://www.etracker.com/de/datenschutz.html</a>
				</p>
				<p></p>
				<p>
